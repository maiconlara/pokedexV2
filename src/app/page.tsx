  ...
  return (
      <main className="flex max-w-screen max-h-screen flex-col items-center justify-between">
        <div className="flex flex-col items-center justify-center gap-10 h-[80vh]">
          <Image src={"./assets/background.webp"} alt="" className="hidden md:block max-w-[716px] max-h-auto"></Image>
          <Image src={"./assets/backgroundMobile.webp"} alt="" className="block md:hidden max-w-[614px] max-h-auto"></Image>
